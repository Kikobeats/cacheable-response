...
// Vendored from @keyvhq/memoize@2.2.4 with fixes for:
// - forced cache bypass during stale-while-revalidate when concurrent requests share pending state
// - stale background refresh failures leaving pending entries stuck forever
